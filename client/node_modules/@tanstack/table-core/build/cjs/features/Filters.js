...
const Filters = {
  ...
  createColumn: (column, table) => {
    return {
      ...
      getFilterFn: () => {
        return utils.isFunction(column.columnDef.filterFn) ? column.columnDef.filterFn : column.columnDef.filterFn === 'auto' ? column.getAutoFilterFn() : filterFns.filterFns[column.columnDef.filterFn];
      },
      getCanFilter: () => {
  ...
  createTable: table => {
    return {
      ...
      getGlobalFilterFn: () => {
        ...
        return utils.isFunction(globalFilterFn) ? globalFilterFn : globalFilterFn === 'auto' ? table.getGlobalAutoFilterFn() : filterFns.filterFns[globalFilterFn];
      },
