  ...
  createColumn: (column, table) => {
    return {
      ...
      getSortingFn: () => {
        ...
        return utils.isFunction(column.columnDef.sortingFn) ? column.columnDef.sortingFn : column.columnDef.sortingFn === 'auto' ? column.getAutoSortingFn() : sortingFns.sortingFns[column.columnDef.sortingFn];
      },
