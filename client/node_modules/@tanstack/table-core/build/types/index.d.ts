 ...
 * @license MIT
 */
declare type CoreCell<TData extends RowData> = {
    id: string;
    getValue: () => any;
    renderValue: () => unknown;
    row: Row<TData>;
...
declare type CoreHeader<TData extends RowData> = {
    id: string;
    index: number;
    depth: number;
    column: Column<TData>;
...
declare function buildHeaderGroups<TData extends RowData>(allColumns: Column<TData>[], columnsToGroup: Column<TData>[], table: Table<TData>, headerFamily?: 'center' | 'left' | 'right'): HeaderGroup<TData>[];

declare type CoreColumnDefType = 'data' | 'display' | 'group';
declare type CoreColumnDefBase<TData extends RowData> = {
...
declare type CoreColumnDefDisplay<TData extends RowData> = CoreColumnDefBase<TData> & {
    id: string;
};
declare type CoreColumnDefDisplayWithStringHeader<TData extends RowData> = CoreColumnDefBase<TData> & {
    header: string;
    id?: string;
};
declare type CoreColumnDefAccessorFn<TData extends RowData> = CoreColumnDefBase<TData> & {
    accessorFn: AccessorFn<TData>;
    id: string;
};
declare type CoreColumnDefAccessorKey<TData extends RowData> = CoreColumnDefBase<TData> & {
    accessorKey: keyof TData;
    id?: string;
};
declare type CoreColumnDef<TData extends RowData> = CoreColumnDefDisplay<TData> | CoreColumnDefDisplayWithStringHeader<TData> | CoreColumnDefAccessorFn<TData> | CoreColumnDefAccessorKey<TData>;
declare type CoreColumnDefResolved<TData extends RowData> = Partial<UnionToIntersection<CoreColumnDef<TData>>>;
declare type CoreColumn<TData extends RowData> = {
    id: string;
    depth: number;
    accessorFn?: AccessorFn<TData>;
...
declare function createColumn<TData extends RowData>(table: Table<TData>, columnDef: ColumnDef<TData>, depth: number, parent?: Column<TData>): Column<TData>;
...
declare type TransformFilterValueFn<TData extends RowData> = (value: any, column?: Column<TData>) => unknown;
declare type ColumnFilterAutoRemoveTestFn<TData extends RowData> = (value: any, column?: Column<TData>) => boolean;
declare type CustomFilterFns<TData extends RowData> = Record<string, FilterFn<TData>>;
declare type FilterFnOption<TData extends RowData> = 'auto' | BuiltInFilterFn | FilterFn<TData>;
...
declare function shouldAutoRemoveFilter<TData extends RowData>(filterFn?: FilterFn<TData>, value?: any, column?: Column<TData>): boolean;
...
declare type SortingFnOption<TData extends RowData> = 'auto' | BuiltInSortingFn | SortingFn<TData>;
...
declare type AggregationFnOption<TData extends RowData> = 'auto' | BuiltInAggregationFn | AggregationFn<TData>;
declare type GroupingColumnDef<TData extends RowData> = {
...
declare function orderColumns<TData extends RowData>(leafColumns: Column<TData>[], grouping: string[], groupedColumnMode?: GroupingColumnMode): Column<TData>[];
...
declare const createRow: <TData extends RowData>(table: Table<TData>, id: string, original: TData | undefined, rowIndex: number, depth: number, subRows?: Row<TData>[] | undefined) => Row<TData>;

declare type Updater<T> = T | ((old: T) => T);
declare type OnChangeFn<T> = (updaterOrValue: Updater<T>) => void;
declare type RowData = object | any[];
declare type TableGenerics = {
    Row?: any;
    Value?: any;
    ColumnMeta?: any;
    TableMeta?: any;
...
declare type Header<TData extends RowData> = CoreHeader<TData> & ColumnSizingHeader;
...
declare function makeStateUpdater(key: keyof TableState, table: unknown): (updater: Updater<any>) => void;
