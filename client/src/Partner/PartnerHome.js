...
function PartnerHome() {
    ...
    return (
        <div className="RegisterHome">
            ...
            {isOpen && CReportBool === true && <Popup
                content={<>
                    <div style={{    margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor : "#f3f3f3", fontWeight : "bold"}}>
                        ...
                        {CReport}
                        <Button variant="primary" onClick={togglePopup} style={{ marginTop: 25 }}>Back</Button>
                    </div>
                </>}
                handleClose={togglePopup}
            />}

            {isOpen && CReportBool === false && <Popup
                content={<>
                    <div style={{ background: "blanchedalmond", padding: 3 }} >
                        <h2>Online Help Center</h2>
                        <p>Report any bugs/Errors</p>
                    ...
                    <Form>
                        ...
                        <Form.Group controlId="ErrTitle" style={{ marginTop: 30, width: "100%" }} >
                    ...
                    <Button variant="primary" onClick={report} style={{ marginTop: 25 }}>Confirm</Button>
                </>}
                handleClose={togglePopup}
            />}
        </div>
